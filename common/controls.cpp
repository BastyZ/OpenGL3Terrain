...
glm::vec3 position = glm::vec3(-6, 3, 8);
// Initial horizontal angle : toward -Z
float horizontalAngle = 10.30f;
// Initial vertical angle : none
float verticalAngle = -4.24f;
...
void computeMatricesFromInputs() {
    ...
    verticalAngle = max(2.2f, min(7.0f, verticalAngle));

    // std::cout << "hor: " << horizontalAngle << std::endl;
    // std::cout << "ver: " << verticalAngle << std::endl;
